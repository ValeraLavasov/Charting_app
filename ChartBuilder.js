...
'#f15c80', '#e4d354', '#2b908f', '#f45b5b', '#91e8e1'],
  ...
  // Changes color of the bar if it`s greater than outlier value
  function showAbnormals(button_id){
    for (i=0 ; i < chart.series[0].data.length ; i++ ){
        if (chart.series[0].data[i].y > outlier )
            chart.series[0].data[i].graphic.attr("fill","black");
    }
  } 

  return {
        buildCharts : drawChart,
        abnormals : showAbnormals,
        createData : makeData 
  };
